          ...
          >
            <div className="space-y-6">
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                ...
                a TED-like experience. Our event is called <span className="text-[#EB0028] font-semibold">TEDxIIMT</span>, 
                where <span className="text-[#EB0028]">x</span> = independently organized TED event.
              </p>
              
              <p className="text-base md:text-lg text-gray-400 leading-relaxed">
                At our TEDxIIMT event, TED Talks video and live speakers will combine to spark deep 
