...
export const blogPosts = [
  {
    ...
    content: `
      ...
      <p>What makes this talk particularly exciting is the speaker's unique perspective on bridging the gap between complex technology and everyday human needs. They've successfully translated cutting-edge research into practical applications that are improving lives across the globe.</p>
  ...
  {
    id: 2,
    title: "Must-Watch TED Talk: The Power of Vulnerability",
    slug: "power-of-vulnerability-ted-talk",
    category: "TED Talk Spotlight",
    excerpt: "This week we're highlighting Brené Brown's powerful talk on vulnerability and its role in courage, authenticity, and connection.",
    content: `
      <p>This week, we want to shine a spotlight on one of the most impactful TED Talks of all time: "The Power of Vulnerability" by Brené Brown. With over 60 million views, this talk has touched hearts and changed perspectives around the world.</p>
      
      <p>Brown's research on shame, vulnerability, and leadership has profound implications for how we connect with others and lead meaningful lives. Her key insight? Vulnerability isn't weakness; it's our most accurate measure of courage.</p>
      
      <h3>Key Takeaways:</h3>
      <ul>
        <li>Vulnerability is the birthplace of innovation, creativity, and change</li>
        <li>We cannot selectively numb emotions - when we numb difficult feelings, we also numb joy and happiness</li>
        <li>Shame needs three things to grow: secrecy, silence, and judgment</li>
    ...
    readTime: "4 min read",
    tags: ["TED Talks", "vulnerability", "leadership", "connection"],
    image: "/api/placeholder/600/300",
    featured: true
  },
  {
    ...
    content: `
      ...
      <p><strong>Venue Design:</strong> Every detail matters, from the iconic red circle on stage to the audience seating arrangement. We're creating an intimate space that fosters deep listening and connection.</p>
      ...
      <p>We can't wait to share this journey with all of you. Registration details coming soon!</p>
    `,
    author: "Raj Patel, Event Director",
    publishDate: "2025-09-22",
    readTime: "5 min read",
    tags: ["event planning", "behind the scenes", "community", "students"],
    image: "/api/placeholder/600/300",
    featured: false
  },
  {
    id: 4,
    title: "The Science of Ideas: How Thoughts Spread",
    slug: "science-of-ideas",
    ...
    content: `
      ...
      <p><strong>Emotional Resonance:</strong> Ideas that evoke strong emotions - whether joy, anger, or inspiration - are more likely to be shared and remembered.</p>
      
      <p><strong>Social Currency:</strong> We share ideas that make us look good or help us connect with others who share our values.</p>
      
      <p><strong>Practical Value:</strong> Ideas that help people solve problems or improve their lives have natural staying power.</p>
    ...
    `,
    author: "Dr. Anita Sharma, Academic Advisor",
    publishDate: "2025-09-20",
    readTime: "6 min read",
    tags: ["research", "psychology", "ideas", "social change"],
    image: "/api/placeholder/600/300",
    featured: false
  },
  {
    ...
    content: `
      ...
      <p><strong>Ahmed Khan, 2nd Year Business Administration:</strong> As our logistics coordinator, Ahmed has proven that age is just a number when it comes to organizational skills. His attention to detail and creative problem-solving have been invaluable.</p>
      
      <p><strong>Maria Rodriguez, 4th Year Psychology:</strong> Our speaker liaison, Maria has the unique ability to put people at ease while maintaining the high standards that make TEDx special. Her background in psychology brings depth to our speaker preparation process.</p>
      
      <p>What strikes us most about our student team is their authentic desire to create meaningful change. They're not just organizing an event; they're building a platform for ideas that matter to their generation.</p>
      
      <p>"This isn't just about putting on a show," says Priya. "We're creating space for conversations that need to happen, especially among young people who will inherit the challenges and opportunities of tomorrow."</p>
